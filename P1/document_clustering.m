%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% CSC C11 - Assignment 3 - Document Clustering.
%
...
% much - this script calls your kmeans.m script. What you
% need to do for this part of the assignment is investigate
% how pre-processing of input data affects clustering results.
%
...
% Use *your* function init_centers to get the initial guess for kmeans
init_cent =init_centers(DocVectors,K,'default');
%init_cent =init_centers(DocVectors,K,'kmeans++');
% Call *your* kmeans clustering code to do the work!
[Centers,labels]=kmeans(DocVectors,init_cent,K);
